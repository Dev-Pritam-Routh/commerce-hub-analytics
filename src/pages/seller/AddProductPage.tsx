...
const SellerAddProductPage = () => {
  ...
  return <div className="px-4 py-6 max-w-4xl mx-auto">
      <div className="mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input type="text" name="name" value={product.name} onChange={handleChange} required className="w-full p-2 border rounded-md bg-gray-600" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select name="category" value={product.category} onChange={handleChange} required className="w-full p-2 border rounded-md bg-gray-600">
              ...
              <div className="space-y-2">
                ...
                <input type="number" name="stock" value={product.stock} onChange={handleChange} min="0" required className="w-full p-2 border rounded-md bg-gray-600" />
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <textarea name="description" value={product.description} onChange={handleChange} rows={4} required className="w-full p-2 border rounded-md bg-gray-600" />
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <input type="text" name="imageUrl" value={product.imageUrl} onChange={handleImageUrlChange} placeholder="https://example.com/image.jpg" className="w-full p-2 border rounded-md bg-gray-600" />
              </div>
            </div>
